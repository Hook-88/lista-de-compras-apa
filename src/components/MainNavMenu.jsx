...
export default function MainNavMenu() {
    ...
    return (
        <Menu className="fixed inset-x-0 top-0 text-2xl">
            <Menu.Button className="px-3 py-2 fixed z-50 text-3xl">
                {open => !open ? <IoMenu /> : <IoMenu className="text-white"/>}
            </Menu.Button>
            <Menu.Dropdown className="fixed inset-x-0 top-0 text-center z-40 bg-sky-700 grid gap-2 pt-2 pb-4 text-white shadow-md">        
